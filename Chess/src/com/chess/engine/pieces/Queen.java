...
public class Queen extends Piece {
	...
	private final static int[] candidateMoveVectorCoordinates={-9, -8, -7, -1, 1, 7, 8, 9};
	...
	private static boolean isEighthColumnExclusion(final int currentPosition, final int candidateOffset) {
		return BoardUtils.firstColumn[currentPosition] && (candidateOffset==-7 || candidateOffset==1 || candidateOffset==9);
	}
